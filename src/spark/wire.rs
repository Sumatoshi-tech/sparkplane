...
pub const INVENTORY_SCHEMA: &str = "sparkplane.bootstrap.inventory/v1";
pub const MANIFEST_SCHEMA: &str = "sparkplane.install-manifest/v1";
pub const FINGERPRINT_SCHEMA: &str = "sparkplane.protected-fingerprint/v1";
...
pub const STATUS_SCHEMA: &str = "sparkplane.status/v1";
#[cfg(feature = "appliance")]
pub const DOCTOR_SCHEMA: &str = "sparkplane.doctor/v1";
#[cfg(feature = "appliance")]
pub const CERTIFICATE_SCHEMA: &str = "sparkplane.certificate-status/v1";
#[cfg(feature = "appliance")]
pub const PROBLEM_SCHEMA: &str = "sparkplane.problem/v1";
#[cfg(any(feature = "appliance", test))]
pub const OPERATION_SCHEMA: &str = "sparkplane.operation/v1";
#[cfg(feature = "appliance")]
pub const OPERATION_LIST_SCHEMA: &str = "sparkplane.operation-list/v1";
#[cfg(any(feature = "appliance", test))]
pub const OPERATION_EVENT_SCHEMA: &str = "sparkplane.operation-event/v1";
#[cfg(feature = "appliance")]
pub const TOKEN_SCHEMA: &str = "sparkplane.token/v1";
#[cfg(feature = "appliance")]
pub const TOKEN_LIST_SCHEMA: &str = "sparkplane.token-list/v1";
#[cfg(feature = "appliance")]
#[cfg(all(feature = "appliance", test))]
pub const RECIPE_CATALOG_SCHEMA: &str = "sparkplane.recipe-catalog/v1";
#[cfg(feature = "appliance")]
pub const MODEL_SCHEMA: &str = "sparkplane.model/v1";
#[cfg(feature = "appliance")]
pub const MODEL_LIST_SCHEMA: &str = "sparkplane.model-list/v1";
#[cfg(feature = "appliance")]
pub const REMOVAL_PLAN_SCHEMA: &str = "sparkplane.removal-plan/v1";
#[cfg(feature = "appliance")]
pub const INSTANCE_SCHEMA: &str = "sparkplane.instance/v2";
#[cfg(feature = "appliance")]
pub const INSTANCE_LIST_SCHEMA: &str = "sparkplane.instance-list/v1";
#[cfg(feature = "appliance")]
pub const ENGINE_LOG_SCHEMA: &str = "sparkplane.engine-log/v1";
#[cfg(all(feature = "appliance", test))]
pub const COMPATIBILITY_EVALUATION_SCHEMA: &str = "sparkplane.compatibility-evaluation/v1";
...
mod tests {
    use super::{
        ModelArtifactFileDocument, ModelArtifactFormat, ModelArtifactSelectorDocument,
        ModelArtifactsDocument, ModelAuxiliaryArtifactDocument, decode_inventory,
    };

    const INVENTORY: &str = r#"{
        "schema":"sparkplane.bootstrap.inventory/v1",
    ...
    fn model_artifacts_reject_unknown_catalog_fields() {
        const JSON: &str = r#"{"schema":"sparkplane.model-artifacts/v2","format":"gguf","primary":{"path":"model.gguf","bytes":7,"sha256":null},"auxiliary":[],"quantization":null,"capabilities":[],"configured_alias":null,"engine":"hidden"}"#;
        assert!(serde_json::from_str::<ModelArtifactsDocument>(JSON).is_err());
    }

    #[test]
    fn model_artifacts_round_trip_without_losing_exact_files() {
        const JSON: &str = r#"{"schema":"sparkplane.model-artifacts/v2","format":"gguf","primary":{"path":"model.gguf","bytes":7,"sha256":"aaa"},"auxiliary":[{"role":"projector","path":"mmproj.gguf","bytes":3,"sha256":"bbb"}],"quantization":"Q4_K_XL","capabilities":["text","vision"],"configured_alias":"qwen","engine_profile":"coding"}"#;
    ...
    fn auxiliary_roles_round_trip_and_unlabelled_files_fail_closed() {
        ...
        assert!(
            serde_json::from_str::<ModelAuxiliaryArtifactDocument>(
