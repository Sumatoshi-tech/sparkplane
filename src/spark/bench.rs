...
use super::wire::{
    COMPATIBILITY_EVALUATION_SCHEMA, CandidateEvaluationDocument, CandidateStatus,
    CompatibilityEvaluationDocument, FunctionalGateDocument, RecipeCatalogDocument,
    RecipeCompatibilityDocument, RecipeStatus,
};
