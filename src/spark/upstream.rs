...
impl ObservedRoute {
    ...
    pub fn for_process(mut self, pid: u32, started: u64) -> Self {
        self.process_identity = Some((pid, started));
        self
    }

    pub fn matches_process(&self, identity: (u32, u64)) -> bool {
