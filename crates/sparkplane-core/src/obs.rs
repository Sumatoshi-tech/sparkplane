...
//!
//! The IPC envelope (sparkplane-ipc v1) carries a `trace_id` and optional
...
//! - The configured formatter reads the innermost `TraceCtx` at
//!   event time; CLI and appliance install the same context layer.
//!
