...
pub const MODEL_CATALOG_SCHEMA: &str = "sparkplane.models/v2";
const MODEL_ARTIFACTS_SCHEMA: &str = "sparkplane.model-artifacts/v2";
...
mod tests {
    ...
    const RECOMMENDED: &str = include_str!("../../configs/sparkplane/models.toml");
