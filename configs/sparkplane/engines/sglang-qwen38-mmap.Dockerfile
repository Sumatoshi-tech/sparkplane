...
LABEL org.opencontainers.image.source="https://github.com/hashd1ve/qwen38-flash-next-one-dgx-spark" \
      ...
      sparkplane.image-contract="v1" \
      sparkplane.base-manifest="sha256:12d3392bdc8be8d35e9a95f191df6aef99c5114bdbefd41bfdc7e760e6d25ec1" \
      sparkplane.persistence-transformer="sha256-2edb46d75172645bc444853563385f480b5bfb872127d0b281fea2f5a8fc6e28.py" \
      sparkplane.page-cache-transformer="sha256-6530076f56575c6754375ba944f0911282999c30bbd2d5b1bdb7e89cf5e5b4aa.py" \
      sparkplane.post-warmup-transformer="sha256-12714616ca51148aeee0089153826230adc15b66031eba3de07586a81f6544db.py" \
      sparkplane.post-warmup-cleanup="flush_transient_allocator" \
      sparkplane.ple-self-test="sha256-708e870359a4d0f390b60096a6428506af013a8aaf7d796783e689f432ff4744.py" \
      sparkplane.persistence-self-test="sha256-bbaec9843bab2d859db87f05cbd8929638aa6caf1e2cc95754edd89ce4dbad3b.py" \
      sparkplane.page-cache-self-test="sha256-e373f3b21a12ce62066d8b1a3bd8390d7946651def00b5d54e976d07b97a8510.py" \
      sparkplane.post-warmup-self-test="sha256-ba23e86521ba43731da3eff8b58bd438529f6a3341de5c351f01ce898b581372.py" \
      sparkplane.architecture-self-test="sha256-f969092584d6a9d2c8e74f6a9720ed7d4bdb51fca69962b88a8470282f88ce78.py" \
      sparkplane.runtime-self-test="sha256-e4492a172636e0cc6d55b8baebf29313d687ca56bb6d5f2a155f4de3f00b78e0.py" \
      sparkplane.runtime-profile="/tmp/sy-image-contract/engine.toml" \
      sparkplane.runtime-network="private-offline" \
      sparkplane.runtime-build-tools="jit-only" \
      sparkplane.runtime-jit-tools="gcc,g++,cc,c++,cmake,ninja,make,nvcc" \
      sparkplane.runtime-rejected-tools="apt,apt-get,dpkg,dpkg-query,git,curl,wget,pip,pip3,uv" \
      sparkplane.runtime-source="/sgl-workspace/sglang" \
      sparkplane.runtime-source-policy="immutable" \
      sparkplane.runtime-scm-metadata="/sgl-workspace/sglang/.git" \
      sparkplane.runtime-user="65534" \
      sparkplane.runtime-writable="/compile-cache,/tmp" \
      sparkplane.cuda-architecture="12.1"
...
RUN set -eux; \
    ...
    python3 -c 'import ast,sys; source=open(sys.argv[1], encoding="utf-8").read(); ast.parse(source); assert source.count("def _alloc_ple_table(") == 1; assert source.count("_alloc_ple_table(source_weight.shape") == 1; assert source.count("sparkplane.ple-cache/v2") == 1' "${ple_target}"; \
