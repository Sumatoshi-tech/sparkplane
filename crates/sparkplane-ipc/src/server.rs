...
mod tests {
    ...
    use crate::envelope::{SCHEMA_VERSION, SpanId, TraceId};
    use sparkplane_core::Priority;
    use sparkplane_core::obs::{TraceCtx, TraceCtxLayer};
